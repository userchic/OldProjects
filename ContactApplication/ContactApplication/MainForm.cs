...
namespace ContactApplication
{
    public partial class MainForm : Form
    {
        ...
        private void отчетToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\Notebook.mdf;Integrated Security=True;");
            conn.Open();
